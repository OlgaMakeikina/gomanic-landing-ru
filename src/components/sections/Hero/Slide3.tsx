  ...
  return (
    <div className="animate-fade-in flex items-center justify-center min-h-screen py-20 lg:py-0">
      <div className="max-w-6xl w-full mx-auto px-0 lg:px-4">
        <div className="relative bg-black/30 rounded-none lg:rounded-2xl border-0 lg:border lg:border-white/30 p-6 lg:p-12 shadow-none lg:shadow-[0_32px_64px_rgba(0,0,0,0.3)] w-full min-h-[480px] lg:min-h-[520px] flex items-center">
          ...
          <div className="relative z-10 w-full">
            <div className="w-full">
              ...
              {/* Mobile buttons - only secondary action */}
              <div className="lg:hidden mt-8 flex justify-center px-4">
                <HeroButton 
                  onClick={() => onButtonAction('scroll', 'about-gomanic')}
                  variant="secondary"

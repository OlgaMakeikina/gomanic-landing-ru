...
export const defaultSEO = {
  title: 'Профессиональный маникюр - GOMANIC | Санкт-Петербург',
  description: 'Профессиональный маникюр с независимыми специалистами. Японские премиум материалы, полная безопасность и гарантированный результат в Санкт-Петербурге.',
  canonical: 'https://gomanic.ru',
  ogImage: '/images/og-image.jpg',
  twitterCard: 'summary_large_image',
  keywords: [
    'маникюр Санкт-Петербург',
    'профессиональный маникюр',
    'гель лак',
    'наращивание ногтей',
    'педикюр Санкт-Петербург',
    'премиум ногти',
    'маникюр скидка',
    'красота Санкт-Петербург',
    'дизайн ногтей',
    'уход за ногтями'
  ],
  openGraph: {
